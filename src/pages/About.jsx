    ...
    <div className="min-h-screen pt-24 pb-16 bg-gray-50 dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800/50 backdrop-blur-sm p-12 rounded-xl border border-gray-300 dark:border-gray-700 mb-16 shadow-lg"
        >
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-900 dark:text-white">Why Choose ElectricPro?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-white dark:bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-300 dark:border-gray-700 text-center shadow-lg">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800/50 backdrop-blur-sm p-12 rounded-xl border border-gray-300 dark:border-gray-700 shadow-lg"
        >
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-900 dark:text-white">Our Achievements</h2>
