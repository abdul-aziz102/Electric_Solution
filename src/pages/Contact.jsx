      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          <motion.div
            ...
            className="bg-white dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-300 dark:border-gray-700 text-center shadow-lg"
          >
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">info@electricpro.com</p>
            <p className="text-gray-600 dark:text-gray-400">support@electricpro.com</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">123 Electric Avenue</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-300 dark:border-gray-700 shadow-lg">
              ...
              <div className="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <div className="mt-4 pt-4 border-t border-gray-300 dark:border-gray-700">
                  <p className="text-blue-600 dark:text-blue-400 font-semibold">24/7 Emergency Services Available</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-300 dark:border-gray-700 shadow-lg">
              <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Service Areas</h3>
